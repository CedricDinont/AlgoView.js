...
/*
			...
			//me.editor.session.setBreakpoints();
			*/
			
		//	var range = new Range(1, 2, 1, 2);
		//	var marker = me.editor.getSession().addMarker(range, "ace_active_line", "background", false);
		//	me.editor.renderer.addGutterDecoration(0, "current_line");
			/*
me.editor.getSession().setAnnotations([
    {
        row:0, 
        column:0, 
        text:"Tooltip", 

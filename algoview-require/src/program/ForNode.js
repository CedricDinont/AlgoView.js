define("ForNode",
["Node", "ArithmeticExpressionNode", "AssignNode", "TestNode", "InvalidExpressionException", "InternalError"],
function(Node, ArithmeticExpressionNode, AssignNode, TestNode, InvalidExpressionException, InternalError){

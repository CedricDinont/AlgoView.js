 ...
 */
 ...
 define("MemoryTableView",
["View", "PointerMemoryValue"],
function(View, PointerMemoryValue) {
	...
	this.update = function(memory){
		...
		if(memory != undefined){
			...
			for(var i= startAddress ; i<= endAddress; i++){
				...
				if( unit != undefined && value instanceof PointerMemoryValue &&  value != PointerMemoryValue.NIL.getPrimitiveValue() && memory.getUnit( value ) == undefined  ){
					className = "invalid";
				}

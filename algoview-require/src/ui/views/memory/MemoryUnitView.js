 ...
 */
  ...
  define("MemoryUnitView",
["MathUtils", "ArrayDataType", "Variable", "PointerMemoryValue" ],
function(MathUtils, ArrayDataType, Variable, PointerMemoryValue) {
...
MemoryUnitView.prototype.update = function(){
	...
	if( !this.composedType ){
		...
		if( this.memoryUnit.getValue() instanceof PointerMemoryValue ){
			...
			// null pointer
			if( this.memoryUnit.getValue()  == PointerMemoryValue.NIL.getPrimitiveValue() ){

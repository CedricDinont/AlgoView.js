...
VariableNameNode, VariableTypeNode, FloatDataType, FloatMemoryValue) {
	...
	function ATanFunctionNode() {
		BuiltInFunctionNode.call(this);
		
		// Name
		this.children.push(new FunctionNameNode(undefined, undefined, "atan"));
	...
	ATanFunctionNode.prototype = new BuiltInFunctionNode();
	ATanFunctionNode.prototype.constructor = ATanFunctionNode;
	...
	ATanFunctionNode.prototype.executeBuiltInFunction = function(nodeContext, memory, nodeStack, programRunner) {
		...
		nodeContext.setValue(new FloatMemoryValue(Math.atan(nodeContext.parametersValues.children[0].value.value)));
	}

	return ATanFunctionNode;

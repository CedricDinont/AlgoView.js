 ...
 */
 ...
 define("MemoryUnit",
["MathUtils", "Variable", "MemoryState", "PointerDataType", "ArrayDataType", "StructureDataType", "BooleanDataType"],
function(MathUtils, Variable, MemoryState, PointerDataType, ArrayDataType, StructureDataType, BooleanDataType) {
...
MemoryUnit.prototype.getBaseAddress = function(refAddress) {
	for(var childKey in this.children) {
		...
		if (refAddress >= childAddress 
				&& refAddress < childAddress + child.getDataType().getSize()) {
			return childAddress;
		}
	}

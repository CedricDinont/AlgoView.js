...
define('ace/mode/simple_language_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror'], function(require, exports, module) {
"use strict";
...
importScripts("coucou.js");

importScripts(lib + "antlr-javascript-runtime-3.1/antlr3-all-patched.js");
importScripts(lib + "deepCopy/deepCopy.js");

importScripts(src + "program/parser/SimpleLanguageLexer.js");
importScripts(src + "program/parser/SimpleLanguageParser.js");

importScripts(src + "program/Program.js");
importScripts(src + "program/FileLocation.js");
importScripts(src + "program/Node.js");
importScripts(src + "program/ProgramNode.js");
importScripts(src + "program/PrintNode.js");
importScripts(src + "program/IfNode.js");
importScripts(src + "program/WhileNode.js");
importScripts(src + "program/ForNode.js");
importScripts(src + "program/DoWhileNode.js");

importScripts(src + "program/StringNode.js");
importScripts(src + "program/ExpressionNode.js");
importScripts(src + "program/ConditionNode.js");
importScripts(src + "program/ArithmeticExpressionNode.js");
importScripts(src + "program/TestNode.js");
importScripts(src + "program/AndNode.js");
importScripts(src + "program/OrNode.js");
importScripts(src + "program/NotNode.js");
importScripts(src + "program/UnaryMinusNode.js");
importScripts(src + "program/AssignableNode.js");
importScripts(src + "program/NumberNode.js");
importScripts(src + "program/StructureElementNameNode.js");
importScripts(src + "program/StructureElementNode.js");
importScripts(src + "program/ArrayElementNode.js");
importScripts(src + "program/PointerDereferenceNode.js");
importScripts(src + "program/NullPointerNode.js");
importScripts(src + "program/AllocateNode.js");
importScripts(src + "program/FreeNode.js");
importScripts(src + "program/AssignStringNode.js");
importScripts(src + "program/AssignNode.js");
importScripts(src + "program/AssignExpressionNode.js");
importScripts(src + "program/IdentifierListNode.js");
importScripts(src + "program/InstructionListNode.js");
importScripts(src + "program/ExpressionListNode.js");
importScripts(src + "program/FunctionNode.js");
importScripts(src + "program/FunctionListNode.js");
importScripts(src + "program/FunctionCallNode.js");
importScripts(src + "program/FunctionNameNode.js");
importScripts(src + "program/FunctionParametersListNode.js");
importScripts(src + "program/FunctionParameterDeclarationNode.js");
importScripts(src + "program/ReturnNode.js");
importScripts(src + "program/StructureDeclarationListNode.js");
importScripts(src + "program/RandomNode.js");
importScripts(src + "program/ErrorNode.js");
importScripts(src + "program/AddressNode.js");
importScripts(src + "program/ContentNode.js");
importScripts(src + "program/DereferenceNode.js");
importScripts(src + "program/BeginNode.js");
importScripts(src + "program/EndNode.js");
	
importScripts(src + "program/VariableTypeNode.js");
importScripts(src + "program/VariableNameNode.js");
importScripts(src + "program/VariableDeclarationNode.js");
importScripts(src + "program/StructureDeclarationNode.js");	
importScripts(src + "program/StructureNameNode.js");
		
importScripts(src + "program/VariablesDeclarationListNode.js");
importScripts(src + "program/VariablesDeclarationNode.js");
importScripts(src + "execution/NodeStack.js");
importScripts(src + "execution/Breakpoint.js");
importScripts(src + "execution/BreakpointList.js");
importScripts(src + "execution/ProgramRunner.js");
importScripts(src + "execution/ProgramRunnerEvent.js");


importScripts(src + "utils/MathUtils.js");
importScripts(src + "utils/JSUtils.js");
importScripts(src + "model/AbstractModel.js");

importScripts(src + "program/DataType.js");
importScripts(src + "program/BooleanDataType.js");
importScripts(src + "program/IntegerDataType.js");
importScripts(src + "program/FloatDataType.js");
importScripts(src + "program/CharacterDataType.js");
importScripts(src + "program/PointerDataType.js");
importScripts(src + "program/ArrayDataType.js");
importScripts(src + "program/StructureDataType.js");

importScripts(src + "execution/Memory.js");
importScripts(src + "execution/MemoryUnit.js");
importScripts(src + "execution/MemoryUnitHashTable.js");	
importScripts(src + "execution/Heap.js");
importScripts(src + "execution/Stack.js");
importScripts(src + "execution/Variable.js");
importScripts(src + "execution/MemoryState.js");

importScripts(src + "execution/MemoryValue.js");
importScripts(src + "execution/BooleanMemoryValue.js");	
importScripts(src + "execution/IntegerMemoryValue.js");
importScripts(src + "execution/FloatMemoryValue.js");	
importScripts(src + "execution/CharacterMemoryValue.js");
importScripts(src + "execution/PointerMemoryValue.js");

importScripts(src + "exceptions/Exception.js");
importScripts(src + "exceptions/InvalidAddressException.js");
importScripts(src + "exceptions/PartOfPrimitiveTypeException.js");
importScripts(src + "exceptions/AlreadyAllocatedSegmentException.js");
importScripts(src + "exceptions/IllegalArgumentException.js");
importScripts(src + "exceptions/DoubleFreeException.js");
importScripts(src + "exceptions/EmptyStackException.js");	
importScripts(src + "exceptions/StackOverflowException.js");
importScripts(src + "exceptions/BadVariableNameException.js");	
...
oop.inherits(SimpleLanguageWorker, Mirror);
...
}).call(SimpleLanguageWorker.prototype);
